...
$b = array(
    ...
    /* 数据库配置 */
    'DB_TYPE'              => 'mysql', // 数据库类型
    'DB_HOST'              => 'hdm144528485.my3w.com', // 服务器地址
    'DB_NAME'              => 'hdm144528485_db', // 数据库名
    'DB_USER'              => 'hdm144528485', // 用户名
    'DB_PWD'               => 'huyiwill',  // 密码
    'DB_PORT'              => '3306', // 端口
    'DB_PREFIX'            => 'easy_', // 数据库表前缀

    /* 模版相关配置 */
    'TMPL_DEFAULT_THEME'   => 'default',//'default',  //默认模版主题
    ...
    'TMPL_PARSE_STRING'    => array(
        ...
        '__CSS__'    => __ROOT__ . '/Public/news/css',
        '__JS__'     => __ROOT__ . '/Public/news/js',
        '__IMAGES__' => __ROOT__ . '/Public/news/img',
        '__FONTS__'  => __ROOT__ . '/Public/news/fonts',
    ),
